    ...
    <div id="layoutSidenav">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" href="<?= base_url('c_Dashboard/pengaduan') ?>" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                            <div class="sb-nav-link-icon"><i class="fa fa-database"></i></div>
                            lihat pengaduan
                        </a>
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container-fluid px-4">
                    <h1 class="mt-4">Selamat datang <?= $user['nama_petugas'] ?></h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active"> di tempat pengaduann</li>
                    </ol>
                    <div class="row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <div class="card bg-success text-white mb-4">
                                <div class="card-body">Tulis catatan </div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a href="<?= base_url('c_Dashboard/tuliscatatan ') ?>" class="btn btn-danger">Go somewhere</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card bg-info text-white mb-4">
                                <div class="card-body">Lihat laporan</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a href="<?= base_url('c_Dashboard/lihatperjalanan') ?>" class="btn btn-danger">Go somewhere</a>
                                </div>
                            </div>
                        </div>
                    </div>
